...
{
  for (size_t i = 0; i < numInstancesRegistered; i++)
  {
...
void ArduPar3Collection::updateParametersFromStream(Stream *inStream, unsigned long timeout)
{
  ...
  int bufPos = 0;
  int inByte;
  unsigned long lastCharMillis = millis();
